        ...
        <div className="min-h-screen flex flex-col">
            ...
            <section className="py-16 flex-grow">
                <div className="max-w-3xl mx-auto px-4">
                    <h2 className="text-3xl font-semibold text-center text-gray-900 mb-8">{textContent.cart_title}</h2>

                    {cartItems.length === 0 ? (
                        <p className="text-center text-gray-500">{textContent.cart_empty}.</p>
                    ) : (
                        <>
                            ...
                            <div className="mt-8 border-t pt-4">
                                <div className="flex justify-between">
                                    <span className="font-semibold">{textContent.cart_subtotal}:</span>
                                    <span className="font-semibold">{totalPrice.toFixed(2)} €</span>
                                </div>
                                <div className="flex justify-between mt-2">
                                    <span className="font-semibold">{textContent.cart_shipping}:</span>
                                    <span className="font-semibold">{shippingCost.toFixed(2)} €</span>
                                </div>
                                <div className="flex justify-between mt-2">
                                    <span className="font-semibold">{textContent.cart_total}:</span>
